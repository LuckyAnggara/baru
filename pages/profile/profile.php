...
<head>
    ...
    <title>Profile | BNI Garut E-Office System</title>
    <!-- Favicon-->
            ...
            <!-- PROFILE PIC -->
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Profile Picture <small><?php echo strtoupper($_SESSION['nama']);?></small>
                            </h2>
                        </div>
                        <div class="body">
                            <div id="aniimated-thumbnials" class="list-unstyled row clearfix">
                            <a href="../../images/profile/<?php echo strtoupper($_SESSION['username']);?>.jpg" data-sub-html="Demo Description">
                                <img class="img-responsive thumbnail" src="../../images/profile/<?php echo strtoupper($_SESSION['username']);?>.jpg">
                            </a>
                            </div>
                            <div class="row clearfix">
                            <div class="col-lg-offset-6 col-md-offset-4 col-sm-offset-6 col-xs-offset-7">
                                <button type="button" class="btn btn-primary m-t-15 waves-effect">UPDATE PROFILE</button>
                            </div>
                        </div>
                        </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                    <div class="card">
                        <div class="header">
                            <h2>
                                My Profile <small><?php echo strtoupper($_SESSION['nama']);?></small>
                            </h2>
                        </div>
                        <div class="body">
                            <form class="form-horizontal" name="profile" method="POST">
                                <div class="row clearfix">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-offset-8 col-md-offset-4 col-sm-offset-6 col-xs-offset-7">
                                        <button type="button" class="btn btn-primary m-t-15 waves-effect">SAVE CHANGES</button>
                                    </div>
                                </div>
                            </form>
                        </div>
